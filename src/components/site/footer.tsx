...
export function Footer() {
  return (
    <footer className="bg-navy pb-7 pt-12 text-[#cfd3e2]">
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="mb-5 flex flex-wrap items-start justify-between gap-8 border-b border-white/15 pb-7">
          ...
          <FooterContact icon={<Mail className="h-[22px] w-[22px]" />} label="Email">
            <a href="mailto:andrea.foran@gmail.com" className="text-[#f4d9e2] underline">andrea.foran@gmail.com</a>
          </FooterContact>

          <FooterContact icon={<Phone className="h-[22px] w-[22px]" />} label="Phone">
            <a href="tel:+36303491670" className="text-[#f4d9e2] underline">+36 30 349 1670</a>
          </FooterContact>

          <FooterContact icon={<CalendarDays className="h-[22px] w-[22px]" />} label="Book Online">
            <a href={CALENDLY_URL} target="_blank" rel="noopener" className="text-[#f4d9e2] underline">Calendly</a>
          </FooterContact>
        </div>
        <p className="text-center text-[0.95rem] text-[#9ba1bd]">foranandrea.hu © 2026 · All rights reserved</p>
      </div>
    </footer>
  )
}
